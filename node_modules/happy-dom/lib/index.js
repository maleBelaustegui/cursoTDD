...
export { GlobalWindow, Window, DataTransfer, DataTransferItem, DataTransferItemList, URL, Location, MutationObserver, ResizeObserver, Blob, File, FileReader, DOMException, History, CSSStyleDeclaration, Screen, AsyncTaskManager, NodeFilter, Event, EventTarget, UIEvent, ErrorEvent, FocusEvent, AnimationEvent, CustomEvent, InputEvent, KeyboardEvent, MouseEvent, ProgressEvent, SubmitEvent, WheelEvent, DOMParser, Document, HTMLDocument, XMLDocument, SVGDocument, Element, HTMLCollection, HTMLFormControlsCollection, HTMLElement, HTMLTemplateElement, HTMLFormElement, HTMLInputElement, HTMLTextAreaElement, HTMLImageElement, Image, HTMLScriptElement, HTMLLinkElement, HTMLStyleElement, HTMLSlotElement, HTMLLabelElement, HTMLMetaElement, HTMLMediaElement, HTMLAudioElement, HTMLVideoElement, HTMLBaseElement, HTMLIFrameElement, SVGElement, SVGGraphicsElement, SVGSVGElement, DocumentFragment, ShadowRoot, Node, Text, Comment, DocumentType, NodeIterator, TreeWalker, CustomElementRegistry, XMLParser, XMLSerializer, CSSStyleSheet, CSSRule, CSSContainerRule, CSSFontFaceRule, CSSKeyframeRule, CSSKeyframesRule, CSSMediaRule, CSSStyleRule, CSSSupportsRule, Storage, DOMRect, URLSearchParams, Selection, Range, HTMLDialogElement, Attr, ProcessingInstruction, FileList, AbortController, AbortSignal, Request, Response, Headers, FormData, EventPhaseEnum, VirtualConsoleLogLevelEnum, VirtualConsoleLogTypeEnum, VirtualConsole, VirtualConsolePrinter };
